...
public class UploadServlet extends HttpServlet {
    ...
    private static final String UPLOAD_DIRECTORY = "filestore/pollimage";
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                if (!item.isFormField()) {
                    ...
                    getServletContext().getRequestDispatcher("/jsp/addpoll.jsp").forward(request, response);
                    return;
                }
       	    ...
       	    if (pname != null && description != null && fileName != null ) {
              	PollDAO pollDao = DaoFactory.getInstance("hibernate").getPollDao();	  
          	
				if(!pollDao.addPoll(new Poll(pname, description, fileName))) {
